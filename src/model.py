"""
Diffusion Model From Scratch - Model Architecture
"""
import torch
...
class DiffusionModelFromScratch(nn.Module):
    """
    Main model for diffusion model from scratch.
    """
...
def build_model(config):
    model = DiffusionModelFromScratch(config)
