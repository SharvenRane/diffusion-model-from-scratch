"""
Diffusion Model From Scratch - Dataset
"""
import os
import torch
...
class DiffusionModelFromScratchDataset(Dataset):
    """Dataset for diffusion model from scratch."""
...
def get_dataloader(root, split, config):
    ...
    dataset = DiffusionModelFromScratchDataset(root, split, transform)
    return DataLoader(
        dataset,
